<template>
  ...
  >
    ...
    <div class="pb-20 pt-0 mt-0 mb-10" v-if="!selection">
      <div>
        ...
        <div class="footnote text-center m-auto mt-12 opacity-70">
          ...
          <router-link
            :to="'/login'"
            class="underline fadein mt-0 hover:text-blue-200"
          >
            Login
          </router-link>
        </div>
    ...
    <div class="pb-20 pt-0 mt-0 mb-10" v-if="selection == 'join'">
      ...
      <div
        class="flex justify-center text-center mt-16 mx-auto opacity-50 hover:opacity-100 fixed bottom-0 w-full left-0 pb-6"
      >
        <router-link to="/map" class="rounded-lg hover:bg-slate-700 p-3">
          <div>
            <svg
              style="width: 30px; height: auto; margin: auto"
              version="1.1"
              id="_x32_"
          ...
          <div class="mt-2 font-bold uppercase">Find a Tournament</div>
        </router-link>
      </div>
    </div>
  </div>

    ...
    <div class="flex flex-col min-h-screen items-center justify-center">
      ...
      >
        ...
        <div class="flex flex-col text-center">
          <label class="text-gray-700">Enter your name</label>
          <input
            type="text"
            id="large-input"
          ...
          <button
            @click="joinBracket"
            class="fadein mt-4 text-3xl px-6 py-3 text-lg font-bold text-white bg-blue-500 rounded-lg hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50"
          >
            Join!
          </button>
        </div>

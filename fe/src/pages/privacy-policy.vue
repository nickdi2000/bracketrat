<template>
  <div class="card pt-15 mt-12 mx-4">
    <div class="p-5 mx-5">
      ...
      <div class="information-we-collect">
        <h2>Information We Collect</h2>
        <p>
          We collect personal information that you voluntarily provide to us
          when registering at BracketForce, expressing an interest in obtaining
          information about us or our products and services, when participating
          in activities on the WebApp (such as posting messages in our online
        ...
        <ul>
          ...
          <li>
            Player Information: Information related to tournament participation,
            such as team names, player names, and match results.
          </li>
        </ul>
      </div>

      <div class="how-we-use-information">
        <h2>How We Use Your Information</h2>
        <p>
          We use personal information collected via our WebApp for a variety of
      ...
      <div class="location-information">
        ...
        <p>
          ...
          are using our WebApp, to provide location-based services. If you wish
      ...
      <div class="your-rights">
        ...
        <p>
          ...
          may include the right to (i) request access and obtain a copy of your
          personal information, (ii) request rectification or erasure; (iii)
          restrict the processing of your personal information; and (iv) if
          applicable, to data portability. To make such a request, please use
